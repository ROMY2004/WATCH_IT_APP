...
public class WATCHHUB {
    ...
    public static pages.Sign_up_page signuppage;
    public static pages.Log_in_page loginpage;
    public static pages.Subscription_page subscription_page;
    ...
    public static abstract class USER {
        ...
        public void setSubscription(SUBSCRIPTION Subscription) {
            Subscription = new Basic_Subscription();
            Subscription.set_user_id(1);
